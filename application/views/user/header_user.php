    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Employee <sup>page</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('User/data_employees')?>">Data Employees</a>
                        <a class="collapse-item" href="<?php echo base_url('User/data_company')?>">Data Company</a>
                        <a class="collapse-item" href="<?php echo base_url('User/data_salary')?>">Data Employees Salary</a>
                    </div>
                </div>
            </li>
