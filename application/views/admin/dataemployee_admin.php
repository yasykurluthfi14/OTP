                                    ...
                                    <tbody>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?php echo base_url().'Admin/update_employee';?>" method="POST">
                                                                <input type="hidden" class="form-control" value="<?=$data->id_employee?>" name="id_employee">
                                        ...
                                        <div class="modal fade" id="ModalDelete<?php echo $data->id_employee;?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Delete Data Employees</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                    <form action="<?php echo base_url().'Admin/delete_employee';?>" method="POST">
                                                        <strong>Do you want to remove this employee?</strong>
                                                        <div class="form-group">
                    ...
                    <div class="modal fade" id="ModalAdd" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?php echo base_url().'Admin/add_employee';?>" method="POST">
